...
public class RhythmGame extends ScreenAdapter {
    ...
    public RhythmGame()
    {
        ...
        noteTexture = new Texture(Gdx.files.internal("background/note2.png"));
        characterImage = new Texture(Gdx.files.internal("background/frij.png"));
        ...
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/audio1.mp3"));
